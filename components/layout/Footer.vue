    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p class="text-gray-300 mb-4">
            Clube recreativo onde membros e famílias vivem momentos únicos em
            meio à natureza.
          </p>
        ...
        <div>
          <h4 class="text-lg font-semibold mb-4">Documentos</h4>
          <ul class="space-y-2">
            <li>
              <a
            ...
            <li class="text-gray-300 text-sm">Todos os dias<br />8h às 18h</li>
          </ul>
        </div>
      </div>
      ...
      <div class="border-t border-gray-700 mt-8 pt-8 text-center">
        <p class="text-gray-300">
          &copy; 2024 Sapucaia. Todos os direitos reservados.
        </p>
      </div>
    </div>
  </footer>

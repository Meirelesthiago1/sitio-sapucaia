        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-8 md:mb-16">
                ...
                <p class="text-base md:text-xl text-gray-600 max-w-2xl mx-auto">
                    Venha nos visitar e viva uma experiência inesquecível em
                    meio à natureza
                </p>
            </div>
                    ...
                    >
                        ...
                        <div class="space-y-4 md:space-y-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p
                                        class="text-sm md:text-base font-semibold text-gray-800"
                                    >
                                        Endereço
                                    </p>
                                    <p
                ...
                >
                    <div>
                        ...
                        <p class="text-emerald-100">
                            Pesquise por "Sítio Sapucaia" no Google Maps ou GPS.
                            Localizado em Minas Gerais, zona rural.
                        </p>
                    </div>
                    <div>
                        <h4 class="font-bold text-xl mb-3">
                        ...
                        <p class="text-emerald-100">
                            Estacionamento gratuito na área interna do clube,
                            limitado a 2 veículos por membro.
                        </p>
                    </div>
                    <div>
                        <h4 class="font-bold text-xl mb-3">

    ...
    >
      ...
      >
        ...
        <button
          ...
          :class="{
            'opacity-50 cursor-not-allowed': currentIndex === images.length - 1,
          }"
        >
          <svg
            class="w-6 h-6"
          ...
          >
            <div :key="currentIndex" class="flex flex-col items-center">
              ...
              <div class="mt-4 text-center text-white max-w-2xl">
                ...
                <p v-if="currentImage.description" class="text-lg opacity-90">
                  {{ currentImage.description }}
                </p>
                <p v-else-if="currentImage.category" class="text-lg opacity-90">
